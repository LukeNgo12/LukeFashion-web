...
export function useSearching() {
  ...
  const isShowingSearch = ref<boolean>(false);
  ...
  function productMatchesSearch(product: any, searchQuery: string): boolean {
  ...
  function searchProducts(products: any[]): any[] {
    ...
    return search ? products.filter((product: any) => productMatchesSearch(product, search)) : products;
  }
