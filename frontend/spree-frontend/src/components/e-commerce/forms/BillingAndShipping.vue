...
<template>
  <div>
    <!-- Page Header -->
    <div class="mb-8">
      <h1 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">{{$t('forms.billingAndShipping.billingAndShipping')}}</h1>
      <p class="text-gray-600 dark:text-gray-400">{{$t('forms.billingAndShipping.manageYourBilling')}}</p>
    </div>

    <form class="space-y-6 wn-form" @submit.prevent="saveChanges">
      <!-- Billing Address Card -->
      <div
        class="bg-white border border-gray-100 rounded-lg shadow-xs dark:bg-gray-800 dark:border-gray-700">
        <div class="p-6 pb-4 border-b border-gray-100 md:px-8 dark:border-gray-700">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{$t('forms.billingAndShipping.billingAddress')}}</h3>
        </div>
        <!-- Billing Fields -->
        <div class="grid gap-6 p-6 md:p-8 md:grid-cols-2" v-if="customer.billing">
          <div class="w-full space-y-2">
            <label for="billing-first-name"
                ...
                $t('forms.billingAndShipping.firstName')
              }}</label>
            <input
          ...
          <div class="w-full space-y-2">
            <label for="billing-last-name"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{
                $t('forms.billingAndShipping.lastName')
              }}</label>
            <input
          ...
          <div class="w-full space-y-2">
            <label for="billing-phone"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">
              {{$t('forms.billingAndShipping.billingPhone')}}
            </label>
            <input
              id="billing-phone"
          ...
          <div class="w-full space-y-2">
            <label for="billing-company"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300"
            >Company <span class="font-normal text-gray-400 dark:text-gray-500">({{
                $t('forms.billingAndShipping.optional')
              }})</span></label
            >
            <input
              id="billing-company"
          ...
          <div class="w-full space-y-2">
            <label for="billing-address"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{
                $t('forms.billingAndShipping.billing.address1')
              }}</label>
            <input
              id="billing-address"
          ...
          <div class="w-full space-y-2">
            <label for="billing-address-2"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300"
            >{{ $t('forms.billingAndShipping.billing.address2') }} <span
              class="font-normal text-gray-400 dark:text-gray-500">({{
                $t('forms.billingAndShipping.billing.optional')
              }})</span></label
            >
            <input
          ...
          <div class="w-full space-y-2">
            <label for="billing-city"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{
                $t('forms.billingAndShipping.billing.city')
              }}</label>
            <input
              id="billing-city"
          ...
          <div class="w-full space-y-2" v-if="customer.billing.state && customer.billing.country">
            <label for="billing-state"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300"
            >{{ $t('forms.billingAndShipping.billing.state') }} <span class="font-normal text-gray-400 dark:text-gray-500">({{
                $t('forms.billingAndShipping.billing.optional')
              }})</span></label
            >
            <StateSelect
          ...
          <div class="w-full space-y-2" v-if="customer.billing.country">
            <label for="billing-country"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{
                $t('forms.billingAndShipping.billing.country')
              }}</label>
            <CountrySelect id="billing-country" v-model="customer.billing.country"
          ...
          <div class="w-full space-y-2">
            <label for="billing-zip"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{
                $t('forms.billingAndShipping.billing.zip')
              }}</label>
            <input
              id="billing-zip"
          ...
          <div class="w-full space-y-2 col-span-full">
            <label for="billing-email"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ $t('forms.billingAndShipping.billing.email') }}
            </label>
            <input
              id="billing-email"
      ...
      <div
        ...
        <div class="grid gap-6 p-6 md:p-8 md:grid-cols-2" v-if="customer.shipping">
          ...
          <div class="w-full space-y-2">
            <label for="shipping-phone"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ $t('forms.billingAndShipping.phone') }}
            </label>
            <input
              id="shipping-phone"
          ...
          <div class="w-full space-y-2">
            <label for="shipping-address"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{
                $t('forms.billingAndShipping.address1')
              }}</label>
            <input
              id="shipping-address"
          ...
          <div class="w-full space-y-2">
            <label for="shipping-address-2"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300"
            >{{ $t('forms.billingAndShipping.address2') }} <span
              class="font-normal text-gray-400 dark:text-gray-500">({{
                $t('forms.billingAndShipping.optional')
              }})</span></label
            >
          ...
          <div class="w-full space-y-2">
            <label for="shipping-city"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{
                $t('forms.billingAndShipping.city')
              }}</label>
            <input
              id="shipping-city"
          ...
          <div class="w-full space-y-2" v-if="customer.shipping.state && customer.shipping.country">
            <label for="shipping-state"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300"
            >{{ $t('forms.billingAndShipping.state') }} <span class="font-normal text-gray-400 dark:text-gray-500">({{
                $t('forms.billingAndShipping.optional')
              }})</span></label
            >
            <StateSelect
          ...
          <div class="w-full space-y-2" v-if="customer.shipping.country">
            <label for="shipping-country"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{
                $t('forms.billingAndShipping.country')
              }}</label>
            <CountrySelect id="shipping-country" v-model="customer.shipping.country"
          ...
          <div class="w-full space-y-2">
            <label for="shipping-zip"
                   class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{
                $t('forms.billingAndShipping.zip')
              }}</label>
            <input
              id="shipping-zip"
        ...
        <!-- Submit Button -->
        <div
          class="p-6 pt-4 border-t flex border-gray-100 rounded-b-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
